...
DataTable VideoPanel::generateRandomData(int listCount, int valueMax, int valueCount) const
{
    DataTable dataTable;
...
QChart* VideoPanel::createScatterChart(QString title) const
{
...
QChart* VideoPanel::createScatterChart() const
{
